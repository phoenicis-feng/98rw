...
specs:
  ...
  price_input: "$0.435/M"
  price_output: "$0.87/M"
  price_cached: "$0.003625/M"
  pricing_source: "官方定价页 · 2026-08-12"
  speed: "69 tokens/秒"
  ttft: "30.68 秒"
  scores:
    overall: {score: 64, rank: 32}
    verified: {score: 62}
    agentic: {score: 67.3, rank: 33}
    coding: {score: 54.6, rank: 49}
    reasoning: {score: 60.3, rank: 15}
    knowledge: {score: 69.5, rank: 38}
    math: {score: 80.4}
  best_use: "数学解题"
  use_cases:
    - "数学解题"
