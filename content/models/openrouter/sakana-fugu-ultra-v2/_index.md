...
specs:
  ...
  price_output: "$0.0300/K"
  modalities: "text+image+file->text"
  openrouter_id: "sakana/fugu-ultra-v2"
...
Fugu Ultra v2 是由 Sakana AI 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Sakana AI |
| OpenRouter ID | `sakana/fugu-ultra-v2` |
| 上下文窗口 | 1M tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
