...
specs:
  ...
  openrouter_id: "minimax/minimax-m3:batch"
...
MiniMax M3 (batch) 是由 MiniMax 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | MiniMax |
| OpenRouter ID | `minimax/minimax-m3:batch` |
| 上下文窗口 | 524K tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
