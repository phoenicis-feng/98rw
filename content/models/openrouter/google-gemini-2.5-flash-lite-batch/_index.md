...
specs:
  ...
  released: "2025"
  context: "1M tokens"
  price_input: "$0.0000/K"
  price_output: "$0.0002/K"
  modalities: "text+image+file+audio+video->text"
  openrouter_id: "google/gemini-2.5-flash-lite:batch"
...
Gemini 2.5 Flash Lite (batch) 是由 Google 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Google |
| OpenRouter ID | `google/gemini-2.5-flash-lite:batch` |
| 上下文窗口 | 1M tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
