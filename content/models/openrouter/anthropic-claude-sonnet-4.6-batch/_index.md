---
title: "Anthropic Claude Sonnet 4.6 (batch)"
model: true
...
specs:
  ...
  released: "2025"
  context: "1M tokens"
  price_input: "$0.0015/K"
  price_output: "$0.0075/K"
  modalities: "text+image+file->text"
  openrouter_id: "anthropic/claude-sonnet-4.6:batch"
...
Claude Sonnet 4.6 (batch) 是由 Anthropic 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Anthropic |
| OpenRouter ID | `anthropic/claude-sonnet-4.6:batch` |
| 上下文窗口 | 1M tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
