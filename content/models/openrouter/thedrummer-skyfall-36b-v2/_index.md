...
specs:
  ...
  openrouter_id: "thedrummer/skyfall-36b-v2"
...
Skyfall 36B V2 是由 Thedrummer 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Thedrummer |
| OpenRouter ID | `thedrummer/skyfall-36b-v2` |
| 上下文窗口 | 32K tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
| 模态 | text->text |
