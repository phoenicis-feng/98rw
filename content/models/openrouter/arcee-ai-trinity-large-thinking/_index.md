...
specs:
  ...
  openrouter_id: "arcee-ai/trinity-large-thinking"
...
Trinity Large Thinking 是由 Arcee-Ai 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Arcee-Ai |
| OpenRouter ID | `arcee-ai/trinity-large-thinking` |
| 上下文窗口 | 262K tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
| 模态 | text->text |
