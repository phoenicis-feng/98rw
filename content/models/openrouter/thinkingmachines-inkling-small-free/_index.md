---
title: "Thinking Machines Inkling Small (free)"
model: true
...
specs:
  ...
  openrouter_id: "thinkingmachines/inkling-small:free"
...
Inkling Small (free) 是由 Thinking Machines 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
| OpenRouter ID | `thinkingmachines/inkling-small:free` |
| 上下文窗口 | 1M tokens |
| 输入价格 | 免费 |
| 输出价格 | 免费 |
