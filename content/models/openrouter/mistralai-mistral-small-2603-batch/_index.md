...
specs:
  ...
  openrouter_id: "mistralai/mistral-small-2603:batch"
...
Mistral Small 4 (batch) 是由 Mistral AI 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Mistral AI |
| OpenRouter ID | `mistralai/mistral-small-2603:batch` |
| 上下文窗口 | 262K tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
| 模态 | text+image->text |
