---
title: "DeepSeek DeepSeek V4 Flash Latest"
model: true
...
DeepSeek V4 Flash Latest 是由 ~Deepseek 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | ~Deepseek |
| OpenRouter ID | `~deepseek/deepseek-v4-flash-latest` |
| 上下文窗口 | 1M tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
| 模态 | text->text |
