---
title: "Inclusion AI Ling 3.0 Flash Fin (free)"
model: true
...
specs:
  ...
  openrouter_id: "inclusionai/ling-3.0-flash-fin:free"
...
Ling 3.0 Flash Fin (free) 是由 Inclusion AI 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Inclusion AI |
| OpenRouter ID | `inclusionai/ling-3.0-flash-fin:free` |
| 上下文窗口 | 262K tokens |
| 输入价格 | 免费 |
| 输出价格 | 免费 |
| 模态 | text->text |
