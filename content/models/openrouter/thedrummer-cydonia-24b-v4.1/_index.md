...
specs:
  ...
  price_output: "$0.0005/K"
  modalities: "text->text"
  openrouter_id: "thedrummer/cydonia-24b-v4.1"
...
Cydonia 24B V4.1 是由 Thedrummer 提供、通过 OpenRouter 平台聚合的模型。该模型在 OpenRouter 上提供统一的 API 接口。
...
|------|------|
| 厂商 | Thedrummer |
| OpenRouter ID | `thedrummer/cydonia-24b-v4.1` |
| 上下文窗口 | 131K tokens |
| 输入价格 | $0.0000/M |
| 输出价格 | $0.0000/M |
| 模态 | text->text |
